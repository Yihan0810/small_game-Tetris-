...
def main():
    ...
    pygame.display.set_caption('俄罗斯方块_测试')

    font1 = pygame.font.SysFont('SimHei', 24)  # 黑体24
    font2 = pygame.font.SysFont('SimHei', 72)  # GAME OVER 的字体
...
def _draw_info(screen, font, pos_x, font_height, score):
    ...
    print_text(screen, font, pos_x, 50 + (font_height + 6) * 4, f'Made by')
    print_text(screen, font, pos_x, 60 + (font_height + 6) * 4, f'Yihan Wang')
